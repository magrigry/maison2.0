...
?>
<?php
if(!isset($_POST['selectInfoUser'])){die('Error');}
require_once'../../../app/bdd.php';
require_once '../../../modele/gestionCompte.php'; //Fonctions sql
$user = $_POST['selectInfoUser'];
$data=infoUser($user, $bdd)->fetch();

echo 'Pseudo: '.$data['pseudo'].'</br>';
echo 'Mail: '.$data['mail'].'</br>';
echo 'Date inscirption: '.$data['date_inscription'].'</br>';
echo 'ip: '.$data['ip'].'</br>';
echo 'last_connection: '.$data['last_connection'].'</br>';
