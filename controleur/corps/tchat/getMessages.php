...
fputs($monfichier, "page controleur/corps/requete/tchat/messageEnvoyes.php\n");
...
while ($data=$messages->fetch()){
	echo '------';
	echo '<div class=""tchatGetAuteur>'.$data['auteur'].'</div>';
	echo '<div class=""tchatGetDate>'.$data['date'].'</div>';
	echo '<div class=""tchatGetAuteurMessage>'.$data['message'].'</div>';
}
?>